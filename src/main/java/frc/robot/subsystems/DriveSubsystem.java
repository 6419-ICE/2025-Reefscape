...
public class DriveSubsystem extends SubsystemBase {
    ...
    public void periodic() {
        ...
        Logger.logData("Current Draw", getAverageDriveCurrentDraw());
        ...
        SmartDashboard.putBoolean("Flipped Path", AutoBuilder.shouldFlip());
    ...
    public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
        ...
        if (fieldRelative) speeds = ChassisSpeeds.fromRobotRelativeSpeeds(speeds,Rotation2d.fromDegrees(getHeading()+180));
